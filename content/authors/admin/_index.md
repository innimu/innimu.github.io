...
전문 연구 분야 🔬: 통계학 석사 과정에서 베이지안 계층적 메타분석 및 생성형 AI(Diffusion/Transformers)를 깊이 있게 다루었습니다.

산업 실무 경험 💼: 프리랜서, 인턴으로 활동하며 산업 수요 예측 모델링 등 실제 비즈니스 문제를 해결한 경험이 있습니다.


최신 AI 기법을 적용한 모델링과 실무형 데이터 분석 경험을 바탕으로 운영 효율화와 비즈니스 성장에 기여하고자 합니다.