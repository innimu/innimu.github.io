...
Research 🔬: 인하대학교 통계학 석사 과정에서 **베이지안 메타분석** 및 **생성형 AI** 분야를 연구했습니다. 학회 우수구연상 , AI 챌린지 최우수상 등 다수 수상으로 유관 분야 역량을 공고히 했습니다.

Work 💼: 프리랜서로 현업 수요 예측 프로젝트를 주도, 시계열 파이프라인을 구축하여 기존 모델 대비 예측 오차(MAPE) 75%를 감소 시키는 성과를 만들었습니다.

Projects 🚀: 다양한 도메인의 프로젝트를 통해 <a href="https://innimu.github.io/projects/"> 광고 클릭률 예측, 추천 시스템, 이상 탐지</a> 등 여러 분야의 데이터를 분석하고 가치를 발굴한 경험이 있습니다.
