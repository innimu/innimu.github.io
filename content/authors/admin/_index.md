...
---
안녕하세요, 
복잡한 데이터 속에서 비즈니스 성과를 발굴하는 데이터 사이언티스트 이정인입니다.

Research 🔬: 인하대학교 통계학 석사 과정에서 **베이지안 계층적 메타분석** 및 **생성형 AI** 분야를 연구했습니다. 학회 우수구연상 , AI 챌린지 최우수상  등 다수 수상으로 모델링 역량을 입증했습니다.

Work 💼: 프리랜서로 한국난방공사 수요 예측 프로젝트를 주도, 시계열 파이프라인을 구축하여 기존 모델 대비 예측 오차(MAPE) 75%를 감소 시키는 성과를 만들었습니다.

Projects 🚀: 다양한 도메인의 프로젝트를 통해 <a href="https://innimu.github.io/projects/">금융 앱 광고, 멀티모달 추천 시스템, 제조</a> 등 여러 분야의 데이터를 분석하고 가치를 발굴한 경험이 있습니다.

정교한 모델링과 실용적 문제 해결 경험을 바탕으로 비즈니스 성장에 기여하겠습니다.