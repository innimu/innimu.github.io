...
- **문제:** User-Item Interaction Matrix의 **Sparsity(희소성)** 가 **99.9861%** 에 달하여, 일반적인 협업 필터링 방식으로는 유의미한 학습이 어려웠습니다. Item에 대한 **이미지 임베딩(4096차원)** 과 **텍스트 임베딩(384차원)** 데이터를 함께 활용하기 위한 방법론 채택이 필요했습니다. 
- **해결:** 데이터 희소성 문제 상황에서 효율적 추천을 수행하는 멀티모달 접근 방식을 채택했습니다.
